...
<!-- ==================== HERO SECTION ==================== -->
<section class="fm-hero" id="home" style="background-image: linear-gradient(rgba(10,15,26,0.85), rgba(10,15,26,0.95)), url('<?php echo get_template_directory_uri(); ?>/assets/images/church-banner.png'); background-size: cover; background-position: center;">
    <div class="fm-container">
        <div class="fm-hero-content">
            <div class="fm-hero-label">Welcome to</div>
            <h1 class="fm-site-logo">
                <a href="<?php echo esc_url(home_url('/')); ?>">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/custom-logo.png" alt="<?php bloginfo('name'); ?> Logo" class="fm-logo-img">
                </a>
            </h1>
        ...
        <div class="fm-hero-image">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pastor-photo.jpg" alt="Dr. Katikala Samuel David Boon - Evangelist" loading="eager">
        </div>
    </div>
    ...
    <div class="fm-container">
        ...
        <div class="fm-about-card">
            <div class="fm-about-image">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pastor-photo.jpg" alt="Dr. Katikala Samuel David Boon" loading="lazy">
            </div>
        ...
        <div class="fm-about-bottom">
            <div class="fm-about-building">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/church-banner.png" alt="Church of Christ Building" loading="lazy">
            </div>
...
<section class="fm-section fm-services" id="services">
    <div class="fm-container">
        ...
        <div class="fm-schedule-grid">
            <?php
            $schedule = array(
                array('day' => 'Sunday', 'time' => '11:00 AM – 1:00 PM', 'name' => 'Sunday Worship Service', 'verse' => 'Hebrews 10:25'),
                array('day' => 'Wednesday', 'time' => '7:00 PM – 9:00 PM', 'name' => 'Midweek Bible Study & Prayer', 'verse' => 'Acts 2:42'),
        ...
        <div class="fm-events-list">
            ...
            <div class="fm-event-card fm-fade-up">
                ...
                <div class="fm-event-info">
                    ...
                    <div class="fm-event-meta"><span>� +91 98856 76689</span></div>
                </div>
                <div class="fm-event-learn">
                    <a href="#contact" class="fm-btn fm-btn-outline fm-btn-rounded">Learn More</a>
                </div>
        ...
        <div class="fm-giving-methods">
            <div class="fm-giving-card fm-fade-up">
                ...
                <div class="fm-giving-detail">
                    ...
                    <div class="fm-value">+91 98856 76689</div>
                </div>
            ...
            <div class="fm-giving-card fm-fade-up">
                ...
                <div class="fm-giving-detail">
                    ...
                    <div class="fm-value">Call +91 98856 76689</div>
                </div>
    ...
    <div class="fm-container">
        ...
        <div class="fm-contact-grid">
            <div>
                ...
                <div class="fm-contact-item">
                    ...
                    <div>
                        ...
                        <div class="fm-contact-value">
                            <a href="https://wa.me/919885676689" target="_blank" rel="noopener">+91 98856 76689</a>
                        </div>
                    </div>
                </div>
                <div class="fm-contact-item">
                ...
                <div class="fm-contact-item">
                    ...
                    <div>
                        ...
                        <div class="fm-contact-value">
                            Sunday Worship: 11 AM – 1 PM<br>
                            Wed Bible Study: 7 PM – 9 PM<br>
                            Daily Morning Prayer: 6 AM
                        </div>
                    </div>
                </div>
            </div>
            <div class="fm-contact-map">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3828.9!2d80.6567!3d16.5110!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a35eff329e3ca39%3A0x2caa9ff07039bb8e!2sChurch%20of%20Christ!5e0!3m2!1sen!2sin!4v1719300000000"
                    allowfullscreen=""
                    loading="lazy"
